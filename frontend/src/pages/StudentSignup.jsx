        ...
        <div className="min-h-screen bg-slate-950 flex flex-col selection:bg-indigo-500/30 font-sans text-slate-100">
            ...
            <header className="relative z-10 flex items-center justify-between gap-4 px-5 py-5 sm:px-7 lg:px-9 mx-auto w-full max-w-7xl">
                ...
                <div className="flex items-center gap-2">
                    <Link to="/login" className="auth-header-btn inline-flex items-center gap-2 rounded-full bg-[#12201f] px-4 py-2.5 text-sm font-bold shadow-[0_12px_30px_rgba(18,32,31,0.24)] transition hover:-translate-y-0.5 hover:bg-[#1f3835]">
                        Login
                        <ArrowRight size={16} />
                    </Link>
                </div>
